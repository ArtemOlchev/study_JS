...
let maybeIncome = document.querySelectorAll(".additional_income-item");
console.log(maybeIncome);
let rightSide = [];
for (let i = 1; i < 7; i++){
    rightSide[i] = document.getElementsByClassName("result-total")[i];
}
console.log(rightSide);

let monthIncom = document.querySelector(".salary-amount"),
    nameOverIncome = document.querySelector(".income-title"),
    amountOverIncome = document.querySelector(".income-title"),
